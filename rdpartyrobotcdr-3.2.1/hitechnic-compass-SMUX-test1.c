 ...
 *
 * THIS CODE WILL ONLY WORK WITH ROBOTC 3.55 beta 2 AND HIGHER.
...
const tMUXSensor HTCOMPASS = msensor_S4_3;
...
task main () {
  ...
  while(true) {
    ...
    if (time1[T1] > 1000) {
      ...
      wait1Msec(500);
      // Set the curreent heading as the value for the offset to be used as the
    ...
    while(nNxtButtonPressed != kEnterButton) {
      ...
      nxtDisplayTextLine(2, "Target: %4d",  );
